...
browser: ['Yuka Multi Device','Safari','1.0.0'],
auth: state
})
...
m = smsg(hisoka, mek)
require("./yuka")(hisoka, m, chatUpdate)
} catch (err) {
console.log(err)
}
})
...
teks1 = `
Welcome To ${metadata.subject} @${num.split("@")[0]}
...
teks2 = `Tetap Putus Asa Jangan
Semangat Dan Jadilah Beban
Keluarga @${num.split("@")[0]} 🤙🗿`
if (anu.action == 'add') {
hisoka.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: teks1})
} else if (anu.action == 'remove') {
hisoka.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: teks2})
}
}
} catch (err) {
console.log(err)
...
CFonts.say(`Yuka Coded By Rasyid`, {
font: 'console',
align: 'center',
...
console.log(color(`[•]`, 'aqua'), color('Nama: Rasyid', 'white'))
console.log(color(`[•]`, 'aqua'), color('Bot Version  : 0.0.1', 'white'))
console.log(color(`[•]`, 'aqua'), color('Status  : Online!', 'white'))
console.log(color(`[•]`, 'aqua'), color('Owner  : 6282260624836', 'white'))
console.log(color(`< ================================================== >`, 'cyan'))
}
